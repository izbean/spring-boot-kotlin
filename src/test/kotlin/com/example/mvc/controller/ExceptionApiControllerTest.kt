...
class ExceptionApiControllerTest {
    ...
    fun postTest() {
        val userRequest = UserRequest().apply {
            ...
            this.email = "gjslgood2@gmail.com"
            this.createdAt = "2022-06-01 14:59:00"
        }
        ...
        mockMvc.perform(
            ...
            jsonPath("\$.name").value("izbean")
        ).andExpect(
            jsonPath("\$.age").value("10")
        ).andExpect(
            jsonPath("\$.email").value("gjslgood2@gmail.com")
        )
    }
